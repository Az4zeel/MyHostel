...
public class FacultyWardenRegister extends AppCompatActivity implements View.OnClickListener {
    private EditText e1;
    private EditText e2;
    private Button b3;
    private Button b4;
    ...
    public void onClick(View view) {
        ...
        if(view == b4){
            ...
            startActivity(new Intent(this, FacultyWardenRegisterForm.class));
        }
    }
}
